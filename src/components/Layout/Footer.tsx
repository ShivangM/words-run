...
const Footer = (props: Props) => {
  return (
    <footer className="dark:bg-dark dark:text-gray-50">
        ...
        <div className="flex flex-col justify-center pt-6 lg:pt-0">
          <div className="flex justify-center space-x-4">
            <a
              ...
              href="#"
              title="Instagram"
              className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 dark:bg-secondary dark:text-gray-900"
            >
              <svg
